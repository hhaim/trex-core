...
In Figure \ref{fig:stlperf} IMIX refer to a mix of packets size see \cite{b7} with an average packet size of 364 bytes.
...
Listing \ref{listing:8} shows a simple example of a low level instructions of the emulation layer. 
